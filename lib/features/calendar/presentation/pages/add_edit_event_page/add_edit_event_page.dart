...
class AddEditEventPage extends StatefulWidget {
  ...
  const AddEditEventPage({super.key, this.event, required this.selectDate});

  @override
  State<AddEditEventPage> createState() => _AddEditEventPageState();
}

class _AddEditEventPageState extends State<AddEditEventPage> with AddEditEventMixin {
  @override
  ...
  void _submit() {
    print("submit ${widget.selectDate}");
    ...
    widget.event == null ? bloc.add(AddCalendarEvent(event)) : bloc.add(UpdateCalendarEvent(event));
